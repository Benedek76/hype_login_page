...
if (isset($_POST['signup'])) {
    ...
    $uname = trim(htmlspecialchars($_POST['uname'])); // get posted data and remove whitespace
...
<!--                 <div class="form-group">
                    <div class="input-group">
                       <form action="action.php" method="post" enctype="multipart/form-data"><input type="file" name="image" id="profile-img" required/>
